...
신재익, 나명진, 이정희, 김, 주디, 정세일 , 윤일준, 최성진, 이지호 
...
향후 일정 미팅 : 기본편 예제 리뷰 및 개인프로젝트 발표

## 2025.11.14

구글 adk 와 rag 경험 공유 : 이지호

## 2025.11.21

기본편 CH 14 streamlit : 이정희  
기본편 CH 17 RAG chatbot : 이정희  
...
심화편 CH 3 사전에 정의된 체인 : 정세일

## 2026.04.10

심화편 CH 4 LECL 고급문법으로 Runnable 활용 : 주디

## 2026.04.17

심화편 CH 5 RAGAS로 답변 평가하기 : 윤일준
